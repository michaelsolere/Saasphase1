...
function task(overrides: Partial<LitterCareTaskSummary> = {}): LitterCareTaskSummary {
  return { id: taskId, litterId, source: "manual", litterPlanItemId: null, litterPlanSeriesId: null, recurrenceDayNo: null, slotNo: null, seriesState: null, organizationTemplateId: null, systemTemplateCode: null, occurrenceNo: 1, category: "veterinary", targetScope: "litter", title: "Visite vétérinaire", description: "Note privée", anchorType: null, anchorDate: null, offsetDays: null, itemKind: "task", priority: "normal", suggestedFor: null, suggestedLocalTime: null, plannedFor: "2026-01-15", scheduledLocalTime: null, scheduleTimezoneName: "Europe/Paris", suggestedStartsOn: null, suggestedStartsLocalTime: null, suggestedEndsOn: null, suggestedEndsLocalTime: null, retainedStartsOn: null, retainedStartsLocalTime: null, retainedEndsOn: null, retainedEndsLocalTime: null, scheduleSource: "suggested", isScheduleLocked: false, scheduleLockedAt: null, scheduleLockedBy: null, revisionNo: 3, status: "planned", resolvedAt: null, resolvedTimezoneName: null, resolvedBy: null, resolutionNote: "Ne pas exporter", completionOrigin: null, completionFact: null, createdAt: "2026-01-01T00:00:00Z", ...overrides };
}
function calendar(
  tasks: readonly LitterCareTaskSummary[],
  filters: { kind: "all" | LitterCareTaskSummary["itemKind"]; category: "all" | LitterCareTaskSummary["category"] } = {
    kind: "all",
    category: "all",
  },
) {
  return buildLitterCareICalendar({ litterName: "Portée Étoile", tasks, filters, generatedAt });
}
