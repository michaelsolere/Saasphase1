  ...
  public: {
    Tables: {
      ...
      litter_planning_model_items: {
        Row: { absolute_max_occurrences: number | null; anchor_type: string; completion_fact_kind: string | null; created_at: string; created_by: string; display_order: number; id: string; initial_materialization_horizon_days: number | null; is_required: boolean; is_selected_by_default: boolean; item_kind: string; model_id: string; organization_id: string; organization_template_id: string; point_local_time: string | null; point_offset_days: number | null; priority: string; recurrence_day_count: number | null; recurrence_end_kind: string | null; recurrence_ends_offset_days: number | null; recurrence_interval_days: number | null; recurrence_kind: string | null; recurrence_starts_offset_days: number | null; updated_at: string; updated_by: string; window_ends_local_time: string | null; window_ends_offset_days: number | null; window_starts_local_time: string | null; window_starts_offset_days: number | null }
        Insert: { absolute_max_occurrences?: number | null; anchor_type: string; completion_fact_kind?: string | null; created_at?: string; created_by: string; display_order: number; id?: string; initial_materialization_horizon_days?: number | null; is_required?: boolean; is_selected_by_default?: boolean; item_kind: string; model_id: string; organization_id: string; organization_template_id: string; point_local_time?: string | null; point_offset_days?: number | null; priority?: string; recurrence_day_count?: number | null; recurrence_end_kind?: string | null; recurrence_ends_offset_days?: number | null; recurrence_interval_days?: number | null; recurrence_kind?: string | null; recurrence_starts_offset_days?: number | null; updated_at?: string; updated_by: string; window_ends_local_time?: string | null; window_ends_offset_days?: number | null; window_starts_local_time?: string | null; window_starts_offset_days?: number | null }
        Update: { absolute_max_occurrences?: number | null; anchor_type?: string; completion_fact_kind?: string | null; created_at?: string; created_by?: string; display_order?: number; id?: string; initial_materialization_horizon_days?: number | null; is_required?: boolean; is_selected_by_default?: boolean; item_kind?: string; model_id?: string; organization_id?: string; organization_template_id?: string; point_local_time?: string | null; point_offset_days?: number | null; priority?: string; recurrence_day_count?: number | null; recurrence_end_kind?: string | null; recurrence_ends_offset_days?: number | null; recurrence_interval_days?: number | null; recurrence_kind?: string | null; recurrence_starts_offset_days?: number | null; updated_at?: string; updated_by?: string; window_ends_local_time?: string | null; window_ends_offset_days?: number | null; window_starts_local_time?: string | null; window_starts_offset_days?: number | null }
        Relationships: []
      }
      ...
      litter_planning_model_library_items: {
        Row: {
          anchor_type: string
          completion_fact_kind: string | null
          created_at: string
      ...
      maternal_observation_commands: {
        Row: { client_command_id: string; created_at: string; created_by: string; id: string; litter_care_task_id: string | null; litter_id: string; match_status: string; maternal_observation_id: string; organization_id: string; payload: Json }
        Insert: { client_command_id: string; created_at?: string; created_by: string; id?: string; litter_care_task_id?: string | null; litter_id: string; match_status: string; maternal_observation_id: string; organization_id: string; payload: Json }
        Update: { client_command_id?: string; created_at?: string; created_by?: string; id?: string; litter_care_task_id?: string | null; litter_id?: string; match_status?: string; maternal_observation_id?: string; organization_id?: string; payload?: Json }
        Relationships: []
      }
      maternal_observation_task_links: {
        Row: { created_at: string; created_by: string; id: string; litter_care_task_id: string; litter_id: string; maternal_observation_id: string; organization_id: string; resolution_command_id: string }
        Insert: { created_at?: string; created_by: string; id?: string; litter_care_task_id: string; litter_id: string; maternal_observation_id: string; organization_id: string; resolution_command_id: string }
        Update: { created_at?: string; created_by?: string; id?: string; litter_care_task_id?: string; litter_id?: string; maternal_observation_id?: string; organization_id?: string; resolution_command_id?: string }
        Relationships: []
      }
      ...
      whelping_birth_adjustment_commands: {
        Row: {
          ...
          previous_revision_no: number
          reason: string
          requested_birth_note: string | null
          requested_cancelled_at: string | null
          requested_initial_collar_color: string | null
          requested_occurred_at: string | null
          requested_sex: string | null
          requested_viability: string | null
          requested_weight_grams: number | null
          requested_weight_measured_at: string | null
          requested_weight_note: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "whelping_birth_adjustment_commands_animal_fk"
            columns: ["organization_id", "animal_id"]
            isOneToOne: false
            referencedRelation: "animals"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "whelping_birth_adjustment_commands_birth_fk"
            columns: ["organization_id", "birth_id"]
            isOneToOne: false
            referencedRelation: "whelping_births"
            referencedColumns: ["organization_id", "id"]
          },
          {
            foreignKeyName: "whelping_birth_adjustment_commands_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "whelping_birth_adjustment_commands_event_fk"
          ...
          {
            foreignKeyName: "whelping_birth_adjustment_commands_litter_fk"
            columns: ["organization_id", "litter_id"]
            isOneToOne: false
            referencedRelation: "litter_overview"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "whelping_birth_adjustment_commands_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "whelping_birth_adjustment_commands_session_fk"
          ...
          {
            foreignKeyName: "whelping_birth_adjustment_commands_weight_fk"
            columns: ["organization_id", "weight_measurement_id"]
            isOneToOne: false
            referencedRelation: "animal_weight_measurements"
            referencedColumns: ["organization_id", "id"]
          },
      ...
      whelping_commands: {
        Row: {
          ...
          organization_id: string
          result_birth_order: number | null
          result_sequence_no: number | null
          session_id: string
          sex: string | null
          started_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "whelping_commands_animal_organization_fk"
            columns: ["organization_id", "animal_id"]
            isOneToOne: false
            referencedRelation: "animals"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "whelping_commands_birth_organization_fk"
            columns: ["organization_id", "birth_id"]
            isOneToOne: false
            referencedRelation: "whelping_births"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "whelping_commands_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "whelping_commands_event_organization_fk"
            columns: ["organization_id", "event_id"]
            isOneToOne: false
            referencedRelation: "whelping_events"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "whelping_commands_litter_organization_fk"
            columns: ["organization_id", "litter_id"]
            isOneToOne: false
            referencedRelation: "litter_overview"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "whelping_commands_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "whelping_commands_session_organization_fk"
            columns: ["organization_id", "session_id"]
            isOneToOne: false
            referencedRelation: "whelping_sessions"
            referencedColumns: ["organization_id", "id"]
          ...
          {
            foreignKeyName: "whelping_commands_weight_measurement_organization_fk"
            columns: ["organization_id", "weight_measurement_id"]
            isOneToOne: false
            referencedRelation: "animal_weight_measurements"
            referencedColumns: ["organization_id", "id"]
    ...
    Functions: {
      ...
      generate_litter_care_tasks_from_plan: {
        Args: { p_client_command_id: string; p_litter_id: string; p_plan: Json }
        Returns: {
      ...
      list_whelping_birth_adjustment_history: {
        Args: { p_limit?: number; p_litter_id: string }
        Returns: {
          action_at: string
          adjustment_type: string
          after_birth_note: string
          after_initial_collar_color: string
          after_occurred_at: string
          after_sex: string
          after_viability: string
          after_weight_grams: number
          after_weight_measured_at: string
          after_weight_note: string
          before_birth_note: string
          before_initial_collar_color: string
          before_occurred_at: string
          before_sex: string
          before_viability: string
          before_weight_grams: number
          before_weight_measured_at: string
          before_weight_note: string
          birth_order: number
          reason: string
          session_timezone_name: string
      ...
      whelping_birth_has_downstream_data: {
        Args: {
          p_animal_id: string
          p_birth_id: string
          p_organization_id: string
