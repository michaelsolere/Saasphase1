...
import { getLitterCareCalendarMonth } from "@/features/litter-journal/litter-care-calendar";
...
export default async function LitterCareCalendarPage({ searchParams }: { searchParams: Promise<{ litter?: string; month?: string; kind?: string; category?: string }> }) {
  ...
  return <LitterCareCalendarPanel litters={litters} litter={litter} tasks={result.tasks} todayDate={todayDate} todayLocalTime={todayLocalTime} month={month} kind={kind} category={category} />;
}
