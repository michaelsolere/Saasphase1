...
begin
 ...
 select coalesce(max(pi.display_order),-1)+1 into v_next_display_order from public.litter_plan_items pi where pi.organization_id=v_org and pi.litter_plan_id=v_plan.id;
